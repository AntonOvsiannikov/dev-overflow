...
const QuestionCard: FC<QuestionCardProps> = ({ question }) => {
  const { id, title, tags, author, createdAt, upvotes, answers, views } = question;
  return (
    <div className="card-wrapper rounded-[10px] p-9 sm:px-11">
      ...
      <div className="flex-between mt-6 w-full flex-wrap gap-3">
        <Metric
          ...
          textStyles="body-medium text_dark400_light700"
          isAuthor
        />
        ...
        <div className="flex items-center gap-3 max-sm:flex-wrap max-sm:justify-start">
          <Metric
            ...
            value={upvotes}
            title={`Votes`}
            textStyles="small-medium text_dark400_light800"
            isAuthor
          />
          <Metric
